...
* Routines supporting the use of Windows friendly interface names
* Copyright 2011-2012, Mike Garratt <wireshark@evn.co.nz>
* By Gerald Combs <gerald@wireshark.org>
* Copyright 1998 Gerald Combs
*
* Modfied by Tim Dorssers
*
...
static boolean get8hexdigits(const char *p, DWORD *d)
{
    int digit;
    DWORD val;
    int i;
...
static boolean get4hexdigits(const char *p, WORD *w)
{
    int digit;
    WORD val;
    int i;
...
get_interface_friendly_name_from_device_guid(__in GUID *guid)
{
    ...
    HRESULT hr;
    boolean fallbackToUnpublishedApi=TRUE;
    boolean haveInterfaceFriendlyName=FALSE;
    int size;
    char *name;
